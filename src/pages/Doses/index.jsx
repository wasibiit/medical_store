...
// console.log(offset)
      ...
      if(1<getpermit("doses")){
              ...
              addbtns =<Link to={process.env.PUBLIC_URL + "/add-dose" } className="btn btn-primary btn-icon-split">
...
<Layout>
    ...
    <div className="card shadow mb-4">
        <div className="card-header py-3">
            <h4 className="m-0 font-weight-bold text-primary">Doses</h4>
       ...
       <Table   data={doselist}  height={500} loading={loading}>
                <Column minWidth={70}>
                ...
                <Column minWidth={200} flexGrow={2}>
                    <HeaderCell>Dose <small>(Display name)</small></HeaderCell>
                    <Cell dataKey="name" />
                </Column>
            
                <Column minWidth={200} flexGrow={2}>
                    <HeaderCell>Dose <small>(Short name)</small></HeaderCell>
                    <Cell dataKey="id" />
                </Column>
                ...
                <Column minWidth={120} fixed="right" flexGrow={1}>
                    ...
                    <span className="ml-3">
                    {3<getpermit("doses")? <a href alt={rowData.id} onClick={()=>handleDelete(rowData.id)}>
                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="card shadow mb-0">
                            <div className="card-header py-3">
                                <h6 className="m-0 font-weight-bold text-primary">Edit Dose</h6>
          ...
          <span aria-hidden="true">&times;</span>
...

                            {
                                prloading? <> <div className="prloader"><Spinner animation="border" variant="primary" className="mt-3" /></div>
                                        ...
                                        <Form.Label>Dose (Display name)</Form.Label>
                                            <Form.Control className="form-control-user" name='value' value={name}
                                                onChange={e=>setName(e.target.value)} type="text"  />

                                        </Form.Group>

                                        <Form.Group className="mb-3" controlId="formBasicEmail">
                                        <Form.Label>Dose (Short name)</Form.Label>
                                            <Form.Control className="form-control-user" name='value' value={doseid}
                                                onChange={e=>setDoseid(e.target.value)} type="text"  />
