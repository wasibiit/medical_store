...
const [prices_per_pack, setPrices_per_pack] = useState("");
const [striper_pack, setPriceper_pack] = useState("");
const [unitsper_pack, setUnitsper_pack] = useState("");
                                      ...
                                      <form className="user" onSubmit={updateFormulasfun}>
                                        <div className="row">
                                          <div className="form-group col-lg-4 col-md-6 col-sm-12 col-12">
                                            ...
                                            <span className="form-control-user"  style={{ textTransform: "capitalize" }}> {medicine_names.replace(/_/g, " ")}</span>
                                          </div>
                                          <div className="form-group col-lg-4 col-md-6 col-sm-12 col-12">
                                            <label htmlFor="stocktype">
                                              Medicine Type
                                            </label>
                                            <span className="form-control-user"  style={{ textTransform: "capitalize" }}> {entity_type_ids.replace(/_/g, " ")}</span>
                                          ...
                                          <div className="form-group col-lg-4 col-md-6 col-sm-12 col-12">
                                            ...
                                            <span className="form-control-user"  style={{ textTransform: "capitalize" }}> {brand_ids.replace(/_/g, " ")}</span>
                                            ...
                                            if (
                                              ...
                                              return (
                                                <>
                                                    ...
                                                    <span className="form-control-user">{price_per_unit}</span>
                                                  </div>
                                                  <div className="form-group col-lg-4 col-md-6 col-sm-12 col-12">
                                                    <label htmlFor="units_per_strip">
                                                     Price per strip
                                                    </label>
                                                    <span className="form-control-user">{price_per_strip}</span>
                                                  </div>
                                                  <div className="form-group col-lg-4 col-md-6 col-sm-12 col-12">
                                                    <label htmlFor="units_per_strip">
                                                      Units per strip
              ...
              <div className="p-4">
                <Formik
                  initialValues={{
                    name: `${mdname}`,
                    brand: `${brdname}`,
                    medicine_id: `${medicine_ide}`,
                    price_per_pack: "",
                    salt: "",
                  }}
                  validationSchema={Yup.object().shape({
                    units_per_strip: Yup.string().required("Units per strip is required"),
                  })}
                    ...
                    return (
                      <Form className="user">
                        <div className="row">
                          <div className="form-group col-lg-4 col-md-6 col-sm-12 col-12">
                            <label htmlFor="name">Name</label>
                            <span className="form-control-user" style={{ textTransform: "capitalize" }}>
                      {mdname.replace(/_/g, " ")}</span>
                          </div>
                          <div className="form-group col-lg-4 col-md-6 col-sm-12 col-12">
                            <label htmlFor="stocktype">Medicine Type</label>

                            <span className="form-control-user" style={{ textTransform: "capitalize" }}>
                      {entity_type_ide}</span>
                          </div>
                          <div className="form-group col-lg-4 col-md-6 col-sm-12 col-12">
                            <label htmlFor="stocktype">Brand</label>
                            <span className="form-control-user" style={{ textTransform: "capitalize" }}>
                      {brdname.replace(/_/g, " ")}</span>
                          ...
                          <div className="form-group col-lg-4 col-md-6 col-sm-12 col-12">
                            ...
                            <Field
                              ...
                              className={
                                "form-control-user form-control" +
                                (errors.price_per_pack && touched.price_per_pack
                                  ? " is-invalid"
                                  : "")
                              }
                            />
                          ...
                          <div className="form-group col-lg-4 col-md-6 col-sm-12 col-12">
                            ...
                            <select
                              ...
                              className={
                                "form-control-user form-control" +
                                (errors.unit_id && touched.units_id
                                  ? " is-invalid"
                                  : "")
                              }
                            >
