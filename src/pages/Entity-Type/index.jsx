...
await fetch(API_URL.url+"/entity-type", {
method: "PUT",
headers: {
"Origin": "*",
"Content-Type": "application/json",
...
// console.log(offset)
      ...
      if(1<getpermit("stock_types")){
              ...
              addbtns =<Link to={process.env.PUBLIC_URL + "/add-entitytype" } className="btn btn-primary btn-icon-split">
...
<Layout>
    ...
    <div className="card shadow mb-4">
        <div className="card-header py-3">
            <h4 className="m-0 font-weight-bold text-primary">Medicine Types</h4>
        ...
        {(rowData, rowIndex) => {
          return <span>{rowIndex+1}</span>;
                ...
                <Column minWidth={120} fixed="right" flexGrow={1}>
                    ...
                    <span className="ml-3">
                    {3<getpermit("entity_types")? <a href alt={rowData.id} onClick={()=>handleDelete(rowData.id)}>
                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="card shadow mb-0">
                            <div className="card-header py-3">
                                <h6 className="m-0 font-weight-bold text-primary">Edit Medicine Type</h6>
