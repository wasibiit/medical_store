...
<React.Fragment>
    ...
    <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <Dropdown  as="li" className="nav-item dropdown no-arrow d-sm-none">
            <Dropdown.Toggle as="a" href="#" className="nav-link"  id="searchDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i className="fas fa-search fa-fw"></i>
            </Dropdown.Toggle>

            <Dropdown.Menu className="dropdown-menu dropdown-menu-right p-3 shadow" aria-labelledby="searchDropdown">
